...
<button class="btn btn-secondary pull-right clear-all-booking" style="border-radius:0%" data-toggle="modal" data-target="#addRoom">Clear All Items</button>
    ...
    $(document).on('click', '.cancel-booking', function(e) {
        ...
        if (confirm('Are you sure you want to cancel this booking?')) {
            $.ajax({
                ...
                success: function(response) {
                    alert(response);
                    window.location.href = "index.php?history_reservation";
                    //header("Refresh:0");
...
$(document).on('click', '.clear-all-booking', function(e) {
        e.preventDefault();
        var bookingId = $(this).data('booking-id');
